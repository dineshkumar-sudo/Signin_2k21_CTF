...
function validatedata(cls)
{
   ...
   /* const name2 = document.getElementById("name2").value;
    ...
    /* if (name1 == "" || name2 == "" || name3 == "" || name4 == "" ||name5 == "" || name6 == "" || name7 == "" || name8 == "" || name9 == "" ||name10 == "")
    {
        ...
        {  
            alert("Hurray!  your answer is correct , Please enter OK to continue");   
            totalScore += parseInt(document.getElementById("LiveScore" + i).innerText);
            document.getElementById("next").click();
                
        } 
      /*  
        else if(answer.indexOf(`${name2}`) !== -1)  
        {  
            alert("Hurray!  your answer is correct , Please enter OK to continue");       
            totalScore += parseInt(document.getElementById("LiveScore" + i).innerText);
            document.getElementById("next").click();
        ...
        else if(answer.indexOf(`${name3}`) !== -1)  
        {  
            alert("Hurray!  your answer is correct , Please enter OK to continue");     
            totalScore += parseInt(document.getElementById("LiveScore" + i).innerText);
            document.getElementById("next").click();
        ...
        else if(answer.indexOf(`${name4}`) !== -1)  
        {  
            alert("Hurray!  your answer is correct , Please enter OK to continue");     
            totalScore += parseInt(document.getElementById("LiveScore" + i).innerText);
            document.getElementById("next").click();
        ...
        else if(answer.indexOf(`${name5}`) !== -1)  
        {  
            alert("Hurray!  your answer is correct , Please enter OK to continue");     
            totalScore += parseInt(document.getElementById("LiveScore" + i).innerText);
            document.getElementById("next").click();
        ...
        else if(answer.indexOf(`${name6}`) !== -1)  
        {  
            alert("Hurray!  your answer is correct , Please enter OK to continue");     
            totalScore += parseInt(document.getElementById("LiveScore" + i).innerText);
            document.getElementById("next").click();
        ...
        else if(answer.indexOf(`${name7}`) !== -1)  
        {  
            alert("Hurray!  your answer is correct , Please enter OK to continue");         
            totalScore += parseInt(document.getElementById("LiveScore" + i).innerText);
            document.getElementById("next").click();
        ...
        else if(answer.indexOf(`${name8}`) !== -1)  
        {  
        ...
        else if(answer.indexOf(`${name9}`) !== -1)  
        {  
            alert("Hurray!  your answer is correct , Please enter OK to continue");       
                totalScore += parseInt(document.getElementById("LiveScore" + i).innerText);
            document.getElementById("next").click();
        ...
        else if(answer.indexOf(`${name10}`) !== -1)  
        {  
            alert("Hurray!  your answer is correct , Please enter OK to continue");     
                totalScore += parseInt(document.getElementById("LiveScore" + i).innerText);
            document.getElementById("next").click();
